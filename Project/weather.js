...
function favsFirst() {
  ...
  for (let i = 0; i < favoriteCities.length; i++) {
    ...
    addElement('citymenu' + i, 'zipmenu' + i, 'zipmenu', favoriteCities[i].zipCode, 'span')
  }
